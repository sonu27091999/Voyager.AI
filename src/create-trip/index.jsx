...
function CreateTrip() {
  ...
  return (
    <div className='sm:px-10 md:px-32 lg:px-56 xl:px-10 px-5 mt-10'>
      ...
      <div className='mt-20 flex flex-col gap-10'>
        <div>
          <h2 className='text-xl my-3 font-medium'>
            What is your preferred destination?🗺️
          </h2>
        ...
        <div>
          <h2 className='text-xl my-3 font-medium'></h2>
      ...
      <div>
        <h2 className='text-xl my-10 font-medium'>Who will you be traveling with on your next adventure?</h2>
        <div className='grid grid-cols-3 gap-5 mt-5'>
      ...
      <Dialog open={openDailog}>
        <DialogContent>
          <DialogHeader>
            <DialogDescription>
              <img src='/wlogo.png' className='w-[150px] flex' />
